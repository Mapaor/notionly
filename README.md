...
If you want to see a more comprehensive example and configuration options use the [`./tests/showcase/showcase.typ`](https://github.com/Mapaor/notionly/blob/main/tests/showcase/showcase.typ), which generates the following document:
...
## License
[MIT](https://github.com/Mapaor/notionly/blob/main/LICENSE)
